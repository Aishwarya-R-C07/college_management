...
from fastapi import FastAPI
from staffdetails import staffdetails_instance  # Correct import without quotes

app = FastAPI()

@app.get("/staffdetails")
async def get_all_staffdetails():
    print("Initiating StaffDetails class")  # Adjusted the message for clarity
    return staffdetails_instance.get_staffdetails()
